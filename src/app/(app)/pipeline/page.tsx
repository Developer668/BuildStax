                ...
                <tbody>
                  {rows.map(({ business, campaignName }) => (
                    <tr key={business.id}>
                      ...
                      <td><div className="flex items-center gap-2"><span className="mono text-[10px] font-semibold">{business.score}</span><span className="h-1.5 w-14 overflow-hidden rounded-full bg-muted"><span className="block h-full bg-[#7a9d33]" style={{ width: `${business.score}%` }} /></span></div></td>
