...
export default async function IntegrationsPage() {
  ...
  return (
    <>
      ...
      <section className="mt-4 flex flex-col gap-3 rounded-[6px] border border-[#c8d6ff] bg-[#f1f5ff] px-4 py-3 sm:flex-row sm:items-center sm:justify-between"><div><div className="text-[11px] font-bold text-[#22489e]">Provider research record</div><p className="mt-0.5 text-[10px] text-[#5b6f9d]">Current candidates, prices, evidence limits, and spend policies are tracked in the repository.</p></div><Link href="https://www.zero.xyz" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-[10px] font-bold text-[#285df5] hover:underline">Zero marketplace <ExternalLink className="size-3" /></Link></section>
    </>
  );
}
